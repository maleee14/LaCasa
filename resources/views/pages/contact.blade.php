        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-8 mb-5">
                    ...
                    <form action="#" class="p-5 bg-white border" onsubmit="MessageToWhatsapp()">
    ...
    @push('script')
        <script>
            function MessageToWhatsapp() {
                const urlToWhatsapp =
                    `https://wa.me/628119072423?text=Halo, Nama Saya ${fullname.value} dan Email Saya ${email.value}. Saya ingin menyampaikan ${subject.value} mengenai ${message.value}. Terima kasih atas perhatian Anda. Hormat Saya, ${fullname.value}`;
