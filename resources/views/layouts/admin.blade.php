...
<body>
    <div id="wrapper">
        <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="{{ route('admins.dashboard') }}">LaCasa</a>
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    @auth('admin')
                        <ul class="navbar-nav side-nav">
                            ...
                            <li class="nav-item {{ Request::is('admin/hometypes') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('admin/properties') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('properties.all') }}"
