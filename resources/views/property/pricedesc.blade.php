                        ...
                        <div class="col-md-10">
                            ...
                            @elseif ($prop->type == 'Sale')
                                <span class="d-inline-block bg-danger text-white px-3 mb-3 property-offer-type rounded">For
                                    {{ $prop->type }}</span>
                            @else
                                <span class="d-inline-block bg-info text-white px-3 mb-3 property-offer-type rounded">For
                                    {{ $prop->type }}</span>
                            @endif
                    ...
                    <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
                        ...
                        <div class="ml-auto d-flex align-items-center">
                            <div>
                                ...
                                <a href="{{ route('price.property.desc') }}"
                                    class="view-list px-3 border-right active">Price
